...
public class AggiungiEscursioni2000 extends AggiungiEscursioneController1 {
        ...
        addButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(checkFields()){
                    ...
                    escursione.setData(LocalDateTime.of(datePicker.getModel().getYear(), datePicker.getModel().getMonth()+1, datePicker.getModel().getDay(), hoursInt,minute));
    ...
    public boolean checkFields(){
        ...
        if( companionCombo.getSelectedItem() == null ||
                placeCombo.getSelectedItem() == null || hourCombo.getSelectedItem() == null || datePicker.getModel().isSelected() == false){
